    ...
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
      ...
      <div className="flex items-center border-2 rounded-full px-2 py-1">
        <input
          ...
          className="border-0 outline-none h-full flex-grow pl-1 text-sm text-gray-600 placeholder-gray-400"
        />
        {/* search svg */}
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="w-8 h-8 bg-red-400 rounded-full text-white p-[6px] cursor-pointer hidden md:inline-flex"
        >
          <path
            strokeLinecap="round"
